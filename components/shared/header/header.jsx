...
export default function Header() {
    return (
        <nav className="navbar navbar-light bg-primary fixed-top d-none d-xl-block p-0 py-2 footer-nav">
            <div className="container-fluid p-0">
                <div className="btn-group float-right justify-content-center w-100 shadow-0" role="group" aria-label="footer-button-group">
